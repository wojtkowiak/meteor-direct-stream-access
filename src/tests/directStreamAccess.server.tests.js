    ...
    describe('DirectStreamAccess', () => {
        ...
        describe('#onMessage()', () => {
            ...
            it('should register callback and receive messages', (done) => {
                testDone = done;
                // We need to generate some traffic on the websocket. Connection from a fake client will be sufficient.
        ...
        describe('#preventCallingMeteorHandler', () => {
            ...
            it('should prevent from running a meteor method', (done) => {
                 ...
                 * This does not makes any sense for a real world usage, but for a test it is fine :)
                 */
                fakeClient((client) => {
                    // Because synchronous call to `methodThatShouldNotBeExecuted` will stall here, we will defer the check.
                    Meteor.defer(
